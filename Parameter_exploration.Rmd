...
```
One thing that might be worth checking is whether variation (not covariation) has any effect.
This is most easily accomplished with a totally different function altogether.
