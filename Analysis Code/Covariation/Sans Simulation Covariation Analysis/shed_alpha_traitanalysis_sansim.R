...
R0_nocor<-ggplot(shed_alpha_nocor_lowvar, aes(x=R0))+
  ...
  geom_histogram(data=shed_alpha_nocor_medvar, aes(x=R0,color="Med Var"), binwidth = 1, alpha = .4, fill="darkgreen")+
  geom_histogram(data=shed_alpha_nocor_hivar, aes(x=R0, color="Hi Var"), binwidth = 1, alpha = .4, fill="darkblue")+
...
R0_poscor<-ggplot(shed_alpha_poscor_lowvar, aes(x=R0))+
  ...
  geom_histogram(data=shed_alpha_poscor_medvar, aes(x=R0), binwidth = 1, alpha = .4, color="darkgreen", fill="darkgreen")+
  geom_histogram(data=shed_alpha_poscor_hivar, aes(x=R0), binwidth = 1, alpha = .4, color="darkblue", fill="darkblue")+
  geom_vline(xintercept = R0, linetype="dotdash", color = "red", size=.5)+
...
R0_negcor<-ggplot(shed_alpha_negcor_lowvar, aes(x=R0))+
  geom_histogram(color="pink", fill="pink", alpha= .4, binwidth = 1)+
  geom_histogram(data=shed_alpha_negcor_medvar, aes(x=R0), binwidth = 1, alpha = .4, color="darkgreen", fill="darkgreen")+
  geom_histogram(data=shed_alpha_negcor_hivar, aes(x=R0), binwidth = 1, alpha = .4, color="darkblue", fill="darkblue")+
  geom_vline(xintercept = R0, linetype="dotdash", color = "red", size=.5)+
