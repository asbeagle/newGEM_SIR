...
analytical_parms_alpha = c(c=.1, shed=.05, alpha=.1, gamma=.1, beta=.25, d=.1, 
                           b=2.5, bs=.01, varA=0.45, epsilon=0.01) # R0=3.8
...
abline(h=56, lty=2)
legend("topright",legend=c("No Var","Var"),fill=c("black","blue"), cex=0.95)
...
## continous variation
plot(0:150, apply(storeMatrix.cont.varA.I, 1, mean), col="red", lwd=1.75, type="l", ylim=c(0,250), ylab="N", xlab="Time", main="Cont Var")
lines(0:150, apply(storeMatrix.cont.varA.S, 1, mean), col="blue", lwd=1.75, type="l", ylim=c(0,150), ylab="N", xlab="Time")
