...
// [[Rcpp::export]]
List SIRvarC(NumericVector params, IntegerVector x, double tmax) {
  // Set the demographic parameters that do not vary
  double b = params(0); // birth rate
  double bs = params(1); // density-dependence
  double d = params(2); // death rate
  ...
  double cSD = params(7); // SD in contact rate
   ...
   // convert to lognormal for computing new individual's traits
  ...
  // store initial individuals
  // column 0: ID; column 1: c value; column 2: no. of 2 infections; column 3: alive or not? (alive = 0; not alive=NA)
  for(int i=0; i<100000; i++) {
    storage(i,3) = NA_REAL;
  }
  for (int i=0; i < I; i++) {
...
// [[Rcpp::export]]
List SIRvarS(NumericVector params, IntegerVector x, double tmax) {
  // Set the demographic parameters that do not vary
  double b = params(0); // birth rate
  double bs = params(1); // density-dependence
  double d = params(2); // death rate
  ...
  double a = params(5); // virulence
  double g = params(6); // recovery rate
  double sSD = params(7); // SD in contact rate
  ...
  // store initial individuals
  // column 0: ID; column 1: s value; column 2: no. of 2 infections; column 3: alive or not? (alive = 0; not alive=NA)
  for(int i=0; i<100000; i++) {
    storage(i,3) = NA_REAL;
  }
  for (int i=0; i < I; i++) {
...
// [[Rcpp::export]]
List SIRvarA(NumericVector params, IntegerVector x, double tmax) {
  // Set the demographic parameters that do not vary
  double b = params(0); // birth rate
  double bs = params(1); // density-dependence
  double d = params(2); // death rate
...
// [[Rcpp::export]]
List SIRvarG(NumericVector params, IntegerVector x, double tmax) {
  // Set the demographic parameters that do not vary
  double b = params(0); // birth rate
  double bs = params(1); // density-dependence
  double d = params(2); // death rate
  ...
  double a = params(5); // virulence
  double g = params(6); // recovery rate
  double gSD = params(7); // SD in recovery rate
...
// [[Rcpp::export]]
List SIRnovar(NumericVector params, IntegerVector x, double tmax) {
  // Set the demographic parameters that do not vary
  double b = params(0); // birth rate
  double bs = params(1); // density-dependence
  double d = params(2); // death rate
